...
# validate_url_for_fetch is re-exported here: routers/system_routes.py imports it from
# pipeline rather than from scraper.
from scraper import smart_fetch, validate_url_for_fetch
from constants import (
    KNOWN_INTEGRATIONS, KNOWN_COMPLIANCE,
